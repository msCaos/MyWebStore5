...
<div id="templatemo_wrapper">
	...
	<div id="templatemo_header">
    	<div id="site_title"><h1><a href="http://localhost/${pageContext.request.contextPath }">Online Phone Store</a></h1></div>
        <div id="header_right">
        	<p>
    ...
    <div id="templatemo_menubar">
        ...
        <div id="templatemo_search">
            <form action="${pageContext.request.contextPath }/ProductDisplayServlet" method="get">
                		...
                		<c:forEach items="${categories }" var="category" varStatus="vs">
                			<c:if test="${vs.index !=0}">
                				<c:if test="${vs.index != fn:length(categories)-1 }">
                					<li>
                						<a href="${pageContext.request.contextPath }/ProductDisplayServlet?op=byCid&cid=${category.id}">${category.cname}</a>
                					</li>
                				</c:if>
                			</c:if>
                			<c:if test="${vs.index==0 }">
        ...
        <div id="content" class="float_r">
        	...
        	<c:forEach items="${hotProducts }" var="product" varStatus="vs">
        		<div class="${vs.index % 3 != 2?'product_box':'product_box no_margin_right' }">
		            <h3>${product.pname }</h3>
	            	<a href="${pageContext.request.contextPath }/ProductDisplayServlet?op=findProductById&pid=${product.pid}">
	                ...
	                <a href="${pageContext.request.contextPath }/ProductDisplayServlet?op=findProductById&pid=${product.pid}" class="detail"></a>
            	</div>
