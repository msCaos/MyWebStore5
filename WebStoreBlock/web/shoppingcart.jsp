        ...
        <div id="content" class="float_r">
        	...
        	<form action="">
	        	<table width="680px" cellspacing="0" cellpadding="5">
	                      ...
	                      <c:if test="${!empty user }">
		                      <c:forEach items="${shoppingCar.itemList}" var="item">
									<tr>
			                        	<td><img src="${item.product.imgurl }" style="width: 200px;height: 180px" alt="" /></td>
                    ...
                    <c:if test="${!empty shoppingCar.itemList}"><p><a href="${pageContext.request.contextPath }/placeOrder.jsp?op=myOrder">立即购买</a></p></c:if>
