...
<html>
	...
	<body>
	 ...
	 <form method="post" action="${pageContext.request.contextPath }/admin/ProductServlet?op=modifyProductInfo" enctype="multipart/form-data">
	<%--<form method="post" action="${pageContext.request.contextPath }/ProductServlet">--%>
		<input type="hidden" name="op" value="modifyProductInfo"/>
