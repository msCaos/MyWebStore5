...
<div  style="height:100%;">
  <ul id="navigation">
    <li> <a class="head">商品管理</a>
      <ul>
        <li><a href="${pageContext.request.contextPath}/admin/ProductServlet?op=findAllCategory" target="rightFrame">添加商品</a></li>
        ...
        <li><a href="${pageContext.request.contextPath}/admin/ProductServlet?op=getAllCategory" target="rightFrame">搜索商品</a></li>
